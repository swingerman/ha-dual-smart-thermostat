...
class OpeningsProcessor:
    ...
    def process_openings_config(
        ...
        Args:
            user_input: User input containing timeout configurations
        ...
        for entity_id in selected_entities:
            ...
            if has_opening_timeout or has_closing_timeout:
                ...
                if has_opening_timeout:
                    opening_obj[ATTR_OPENING_TIMEOUT] = user_input[opening_timeout_key]
                if has_closing_timeout:
                    opening_obj[ATTR_CLOSING_TIMEOUT] = user_input[closing_timeout_key]
