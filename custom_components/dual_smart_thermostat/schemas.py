    ...
    advanced_section_schema = vol.Schema(
        {
            vol.Optional(
                ...
                description={
                    "suggested_value": (
                        defaults.get(CONF_COLD_TOLERANCE)
                        if defaults
            ...
            vol.Optional(
                ...
                description={
                    "suggested_value": (
                        defaults.get(CONF_HOT_TOLERANCE)
                        if defaults
                        else DEFAULT_TOLERANCE
                    )
                },
            ...
            vol.Optional(
                CONF_MIN_DUR,
                description={
                    "suggested_value": defaults.get(CONF_MIN_DUR) if defaults else 300
                },
            ...
            vol.Optional(
                ...
                description={
                    "suggested_value": (
                        defaults.get(CONF_KEEP_ALIVE) if defaults else 300
                    )
                },
            ): get_time_selector(min_value=0, max_value=3600),
        }
    ...
    advanced_section_schema = vol.Schema(
        {
            ...
            vol.Optional(
                ...
                description={
                    "suggested_value": (
                        defaults.get(CONF_HEAT_TOLERANCE)
                        if defaults
                        else DEFAULT_TOLERANCE
                    )
                },
            ...
            vol.Optional(
                ...
                description={
                    "suggested_value": (
                        defaults.get(CONF_COOL_TOLERANCE)
                        if defaults
                        else DEFAULT_TOLERANCE
                    )
                },
